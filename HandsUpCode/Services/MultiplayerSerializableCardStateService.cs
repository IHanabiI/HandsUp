...
internal static class MultiplayerSerializableCardStateService
{
    ...
    private static bool HasSameDeckIdentity(SerializableCard left, SerializableCard right)
    {
        return Equals(left.Id, right.Id)
               ...
               && AreSerializedObjectsEquivalent(left.Enchantment, right.Enchantment);
    }
